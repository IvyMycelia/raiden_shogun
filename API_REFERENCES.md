...
type Nation {
  ...
  # Number of turns until this nation can change its war policy
  ...
  # Number of turns until this nation can change its domestic policy
  ...
  resource_production_center: Boolean
    @deprecated(reason: "Use activity_center instead")
  ...
  # Whether or not the nation has the Guiding Satellite project
  guiding_satellite: Boolean

  # Whether or not the nation has the Nuclear Launch Facility project
  nuclear_launch_facility: Boolean

  # Whether or not the nation has the Military Research project
...
type WarAttack {
  ...
  warid: ID @deprecated(reason: "Use war_id instead.")
  ...
  # How many soldiers were defending in the attack
  def_soldiers_used: Int

  # How many soldiers the defender lost in the attack
  def_soldiers_lost: Int

  # How many tanks were sent in the attack
  att_tanks_used: Int

  # How many tanks the attacker lost in the attack
  att_tanks_lost: Int

  # How many tanks were defending in the attack
  def_tanks_used: Int

  # How many tanks the defender lost in the attack
  def_tanks_lost: Int

  # How many aircraft were sent in the attack
  att_aircraft_used: Int

  # How many aircraft the attacker lost in the attack
  att_aircraft_lost: Int

  # How many aircraft were defending in the attack
  def_aircraft_used: Int

  # How many aircraft the defender lost in the attack
  def_aircraft_lost: Int

  # How many ships were sent on the attack
  att_ships_used: Int

  # How many ships the attacker lost in the attack
  att_ships_lost: Int

  # How many ships were defending in the attack
  def_ships_used: Int

  # How many ships the defender lost in the attack
  def_ships_lost: Int
  ...
  # Total iron looted in the attack
  iron_looted: Int
...
type Bulletin {
  ...
  # Alliance the bulletin was posted to, null if type is 1
  alliance: Alliance
  ...
  # When the bulletin was last updated
...
type BulletinReply {
  ...
  # Date that the reply was last edited
  edit_date: DateTimeAuto
...
# Order by clause for Nation.bulletin_replies.orderBy.
...
type TopTradeResourceInfo {
  ...
  # The highest PPU buy offer on the market at the moment
...
type NationResourceStat {
  ...
  # Total food in the game / nations active in the past week
  food: String
...
# Order by clause for Query.bulletin_replies.orderBy.
