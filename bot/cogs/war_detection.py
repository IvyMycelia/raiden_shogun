...
class WarDetectionCog(commands.Cog):
    ...
    def __init__(self, bot: commands.Bot):
        ...
        # Configuration
        self.monitoring_channel_id = 1386829632036409425  # Channel to post notifications
        self.alert_role_id = 1358606073824546996  # Role to ping for defensive wars
    ...
    def get_alliance_members(self) -> List[Dict]:
        """Get all alliance members."""
        try:
            members = get_data.GET_ALLIANCE_MEMBERS(self.alliance_id, self.config.API_KEY)
            if not members:
    ...
    async def war_monitor(self):
        ...
        try:
            ...
            if not wars:
                return
            alliance_members = self.get_alliance_members()
